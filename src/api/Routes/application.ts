...
router.put("/note/:id", isAuthenticated, hasPermission("add_application_note"), validate(applicationNoteSchema), viewUpdateApplicationNote);
...
router.delete("/bulk", isAuthenticated, hasPermission("delete_application"), validate(bulkDeleteSchema), viewDeleteBulkApplications);
