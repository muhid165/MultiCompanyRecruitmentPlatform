...
router.get("/:id", isAuthenticated, hasPermission("view_application"), viewApplicationById); // by ID
...
router.post("/submit", verifyCompanyToken, fileUpload, validate(applicationSchema), viewCreateApplication); //open api
